...
export const getWorkspace = query({
  ...
  handler: async (ctx) => {
    ...
    const [
      ...
      ctx.db.query("jobPhases").withIndex("by_org", (q) => q.eq("organizationId", org._id)).collect(),
      ...
      ctx.db.query("activities").withIndex("by_org_time", (q) => q.eq("organizationId", org._id)).order("desc").collect(),
