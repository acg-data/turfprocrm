...
export const primeTimeGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Stripe checkout", priority: "P0", status: "done", owner: "engineering", detail: "Checkout sessions, customer portal, and webhook-driven subscription state are wired; needs Stripe dashboard config (see docs/production-launch-checklist.md)." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Invite flow", priority: "P1", status: "done", owner: "engineering", detail: "Tokenized email invites with role, seat limits, expiry, and single-use accept at /invite/[token]." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Email notifications", priority: "P1", status: "in_progress", owner: "engineering", detail: "Resend wired for invites, payment-failed dunning, and trial reminders; estimates/invoices/field updates still to come." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Error monitoring", priority: "P0", status: "in_progress", owner: "ops", detail: "Sentry SDK wired behind NEXT_PUBLIC_SENTRY_DSN; needs DSN + alert rules." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Billing operations", priority: "P0", status: "in_progress", owner: "ops", detail: "Plan state, write-blocking on lapse, dunning email, and trial reminders shipped; needs Stripe dashboard config + live-mode verification." },
