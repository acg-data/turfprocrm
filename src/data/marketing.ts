...
export const marketingPages: MarketingPage[] = [
  ...
  },
  {
    ...
    title: "One $99/mo paid plan with green-industry operating depth included.",
    lede: "The commercial offer is simple: a free workspace for up to 10 contacts, then an all-in paid plan that bundles the Arborgold-style modules operators usually see split across higher tiers.",
    primaryAction: "Start free",
    proof: ["Free: 10 contacts", "$99/mo", "Unlimited contacts", "All core modules", "Admin controls", "Job costing"],
    sections: [
      {
        title: "Free account",
        body: "A new operator can create an account, provision a workspace, and test the core CRM before paying.",
        bullets: ["10 contacts included", "Single sign-in account setup", "Lead, CRM, dispatch, field, costing, and profit demo access"],
      },
      {
        title: "$99/mo All-In Pro",
        body: "The paid offer includes the operational features listed across Arborgold-style Starter, Professional, and Enterprise tiers.",
        bullets: ["CRM, estimating, unlimited land measurements, drag-and-drop scheduling, route optimization, job management, communications, invoicing, e-payments, reporting, analytics, and crew time tracking", "Job costing, renewals, material inventory, chemical tracking, autoprice calculator, advanced resources, and integrations", "Plant and tree inventory mapping, sales automation, templates, expense tracking, equipment maintenance, project scheduling, and admin permissions"],
      },
      {
