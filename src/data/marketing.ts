...
export const marketingPages: MarketingPage[] = [
  ...
  },
  {
    ...
    title: "Pricing architecture is ready for packages, plan gates, seats, and billing integration.",
    lede: "The MVP has the SaaS billing model boundary in place. Live Stripe checkout remains a next-phase integration after the operating core is stable.",
    primaryAction: "Review readiness",
    proof: ["Starter", "Pro", "Growth", "Enterprise", "Seats", "Plan gates"],
    sections: [
      {
        title: "Plan shape",
        body: "Plan records, subscriptions, invoices, seats, feature flags, and account health are modeled from day one.",
        bullets: ["Starter for small teams", "Pro for growing operators", "Growth and enterprise controls"],
      },
      {
        title: "Billing boundary",
        body: "The model is Stripe-ready but does not claim live checkout until the billing integration is connected and tested.",
        bullets: ["Stripe customer fields", "Subscription status", "SaaS invoices"],
      },
      {
        title: "Sales readiness",
        body: "The marketing site can support demos and trial interest while the paid checkout path is finalized.",
        bullets: ["Demo CTA", "Operator-specific positioning", "Feature readiness board"],
      },
    ],
  },
  {
